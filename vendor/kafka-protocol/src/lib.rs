...
//!
//! With the `messages_enums` feature, the [`messages`] module provides
//! [`messages::RequestKind`], [`messages::ResponseKind`], and
//! [`messages::ApiKey`] for matching on unknown requests and responses.
//!
...
//! }
//! # }
//! # #[cfg(not(feature = "messages_enums"))]
//! # fn main() {}
//! ```
#![deny(missing_docs)]
