...
This vendored build is generated against [Apache Kafka 4.3.0](https://github.com/apache/kafka/releases/tag/4.3.0).
...
Run `cargo run --manifest-path protocol_codegen/Cargo.toml -- <schema-directory>
src/messages` in this vendored crate to regenerate from an explicit Kafka
schema release.
